...
function makeApi(): RestXApi {
  return {
    ...
    providers: { getState: vi.fn(async () => ({ providers: [], activeProviderId: null })), create: vi.fn(), update: vi.fn(), delete: vi.fn(), setActive: vi.fn(), setSystemProxy: vi.fn(), setCustomHeaders: vi.fn(), test: vi.fn(), refreshExternal: vi.fn() },
    ai: {
