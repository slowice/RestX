...
import type { FrequentSkillsApi } from './features/frequent-skills/shared/api'
import type { HomeApi } from './features/home/shared/api'
import type { PlatformApi } from './platform/shared/platform-api'

export type RestXApi = PlatformApi & HomeApi & AiInspectorApi & CodeReviewApi & KnowledgeMapApi & MailTemplateApi & FrequentSkillsApi
