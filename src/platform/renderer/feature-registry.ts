...
const registeredFeatures = [homeFeature, aiInspectorFeature, codeReviewFeature, mailTemplateFeature, labFeature, settingsFeature] satisfies readonly RendererFeature[]
