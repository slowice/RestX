...
const registeredFeatures = [aiInspectorMainFeature, codeReviewMainFeature, knowledgeMapMainFeature, mailTemplateMainFeature, frequentSkillsMainFeature] satisfies readonly MainFeature[]
